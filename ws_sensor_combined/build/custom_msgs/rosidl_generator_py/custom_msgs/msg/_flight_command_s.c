...
bool custom_msgs__msg__flight_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
{
  /* NOTE(esteve): Call constructor of FlightCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._flight_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FlightCommand");
